function hndl=plotci(obj,x,y,yci,draw_data,geom,dodge,width)
            ...
            for k=1:length(geom)
                switch geom{k}
                    case 'line'
                        hndl.line_handle=plot(obj.current_facet_axes, ... % Added 12.11.2021 PMA
                            x,y,...
                            'LineStyle',draw_data.line_style,...
                            'Color',draw_data.color,...
                            'LineWidth',draw_data.line_size);
                        
                        hndl.extra_point_handle=plot(obj.current_facet_axes, ... % Added 12.11.2021 PMA
                            x(real_neighbors==0),y(real_neighbors==0),'o',...
                            'Color',draw_data.color,...
                    ...
                    case 'lines'
                        ...
                        hndl.lines_handle=plot(obj.current_facet_axes, ... % Added 12.11.2021 PMA
                            xci',yci','LineStyle',draw_data.line_style,...
                            'Color',draw_data.color,...
                            'LineWidth',draw_data.line_size/3);
                        
                    case 'area'
                        %Transparent area (This does what we want but prevents a correct eps
                        hndl.area_handle=patch(obj.current_facet_axes, ... % Added 12.11.2021 PMA
                            'Vertices',vertices,...
                            'Faces',faces,...
                    ...
                    case 'area_only'
                        hndl.area_handle=patch(obj.current_facet_axes, ... % Added 12.11.2021 PMA
                            'Vertices',vertices,'Faces',faces,'FaceColor',draw_data.color,'FaceAlpha',0.2,'EdgeColor','none');
                    ...
                    case 'errorbar'
                        hndl.errorbar_handle=my_errorbar(obj.current_facet_axes, ... % Added 12.11.2021 PMA
                            x,yci(1,:),yci(2,:),bar_width/4,draw_data.color,draw_data.line_size);
                        
                    case 'black_errorbar'
                        hndl.errorbar_handle=my_errorbar(obj.current_facet_axes, ... % Added 12.11.2021 PMA
                            x,yci(1,:),yci(2,:),bar_width/4,'k',draw_data.line_size);
                    ...
                    case 'bar'
                        ...
                        hndl.bar_handle=patch(obj.current_facet_axes, ... % Added 12.11.2021 PMA
                            xpatch,ypatch,[1 1 1],'FaceColor',draw_data.color,'EdgeColor','none');
                   case 'edge_bar'
                        barleft=x-bar_width/2;
                        barright=x+bar_width/2;
                        xpatch=[barleft ; barright ; barright ; barleft];
                        ...
                        [xpatch,ypatch]=to_polar(obj,xpatch,ypatch);
                        hndl.bar_handle=patch(obj.current_facet_axes, ... % Added 12.11.2021 PMA
                            xpatch,ypatch,[1 1 1],'FaceColor',draw_data.color,'EdgeColor','k');
                    case 'point'
                        hndl.point_handle=plot(obj.current_facet_axes, ... % Added 12.11.2021 PMA
                            x,y,draw_data.marker,'MarkerEdgeColor','none','markerSize',draw_data.point_size,'MarkerFaceColor',draw_data.color);
                end
